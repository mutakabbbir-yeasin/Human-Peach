<?php
  ...
  ?>
    <script>
      swal({title: "Opps!", text: "Counsellor registration failed! Password confirmation didn't match.", icon: "error", button: "OK",});
    </script>
<?php
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header bg-light">
            <div class="row">
              <div class="col-md-10 card_header_text">
                <b>Add Counsellor Information</b>
              </div>
          ...
          <form method="post" action="submit-add-counsellor.php" enctype="multipart/form-data">
          ...
          <div class="card-footer text-muted text-center">
            <button type="submit" class="btn btn-danger">Add Counsellor</button>
          </div>
          </form>
        </div>
      </div>        
