<?php
  ...
  ?>
    <script>
      swal({title: "Opps!", text: "Lawyer registration failed! Password confirmation didn't match.", icon: "error", button: "OK",});
    </script>
<?php
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <form method="post" action="submit-add-lawyer.php" enctype="multipart/form-data">
          ...
          <div class="card-footer text-muted text-center">
            <button type="submit" class="btn btn-danger">Add Lawyer</button>
          </div>
          </form>
        </div>
      </div>        
